...
function GUIInit() {
	...
	let guiDesc = {
		...
		'Inputs': {
			...
			'Axis-Angle Input': {
				'Axis X': GUIObjHelpers.CreateNumberSlider(0, -5, 5, 0.001),
				'Axis Y': GUIObjHelpers.CreateNumberSlider(0, -5, 5, 0.001),
				'Axis Z': GUIObjHelpers.CreateNumberSlider(0, -5, 5, 0.001),
			...
			'Quaternion Proportional Input': {
				'X': GUIObjHelpers.CreateNumberSlider(0, -1, 1, 0.001),
				'Y': GUIObjHelpers.CreateNumberSlider(0, -1, 1, 0.001),
				'Z': GUIObjHelpers.CreateNumberSlider(0, -1, 1, 0.001),
				'W': GUIObjHelpers.CreateNumberSlider(1, -1, 1, 0.001),
